...
class RekapUser4Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        Presence::factory(1)->createMany([
            [
                ...
                "presence_enter_time" => Carbon::parse('07:32:00')->format('H:i:s'),
                "presence_out_time" => Carbon::parse('16:15:00'),
                "is_permission" => 0,
                "status" => "Tepat Waktu",
            ...
            [
                ...
                "is_permission" => 0,
                "status" => "Tepat Waktu",
                "working_hours" => Carbon::parse('08:43:00')
            ],
            [
                "user_id" => 4,
                "attendance_id" => 1,
