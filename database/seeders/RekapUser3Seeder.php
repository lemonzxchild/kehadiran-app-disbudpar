...
class RekapUser3Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        Presence::factory(1)->createMany([
            [
                ...
                "presence_enter_time" => Carbon::parse('07:31:00')->format('H:i:s'),
                "presence_out_time" => Carbon::parse('16:10:00'),
                "is_permission" => 0,
                "status" => "Tepat Waktu",
                "working_hours" => Carbon::parse('08:39:00')
            ],
            [
                "user_id" => 3,
                "attendance_id" => 1,
        ...
        Presence::factory(1)->createMany([
            [
                "user_id" => 3,
                "attendance_id" => 1,
                "presence_date" => Carbon::parse('2023-11-1'),
            ...
            [
                "user_id" => 3,
                "attendance_id" => 1,
                "presence_date" => Carbon::parse('2023-11-2'),
                "presence_enter_time" => Carbon::parse('08:30:00')->format('H:i:s'),
                "presence_out_time" => Carbon::parse('16:30:00'),
                "is_permission" => 0,
                "status" => "Terlambat",
