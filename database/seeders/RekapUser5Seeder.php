...
class RekapUser5Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        Presence::factory(1)->createMany([
            ...
            [
                ...
                "presence_enter_time" => Carbon::parse('07:50:00')->format('H:i:s'),
                "presence_out_time" => Carbon::parse('16:40:00'),
                "is_permission" => 0,
                "status" => "Overtime",
                "working_hours" => Carbon::parse('08:50:00')
            ],
            [
                "user_id" => 5,
                "attendance_id" => 1,
