                ...
                <div class="w-100">
                    <div class="mb-3">
                        <x-form-label id="name{{ $employee['id'] }}"
                            label="Nama Pegawai {{ $loop->iteration }} (ID: {{ $employee['id'] }})" />
                    ...
                    <div class="mb-3">
                        <x-form-label id="email{{ $employee['id'] }}" label='Email Pegawai {{ $loop->iteration }}' />
                    ...
                    <div class="mb-3">
                        <x-form-label id="password{{ $employee['id'] }}" label='Password {{ $loop->iteration }}' />
